...
/** /AUTO_REDIRECT_LOGIN_GUARD **/
  ...
  const SidebarPanel = ({ onNavigate }: { onNavigate?: () => void }) => (
    <div className="relative h-full w-full text-white overflow-hidden">
      ...
      {/* Painel glass */}
      <div className="relative m-3 h-[calc(100dvh-24px)] rounded-[26px] border border-white/15 bg-white/[0.06] backdrop-blur-2xl shadow-[0_20px_80px_rgba(0,0,0,.45)] overflow-hidden flex flex-col">
                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="lg:hidden">
                    <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                      ...
                      <SheetContent
                        side="left"
                        className="p-0 w-[88vw] max-w-[360px] border-r border-white/10 bg-transparent"
                      >
