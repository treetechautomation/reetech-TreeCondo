  ...
  (
    ...
    return (
      <div
        ...
        data-sidebar="sidebar"
        data-state={state}
        className={cn("hidden md:flex h-svh w-[--sidebar-width] flex-col border-r bg-sidebar text-sidebar-foreground transition-[width] group-data-[state=collapsed]:w-[--sidebar-width-icon]", className)}
        {...props}
      >
        {children}
      </div>
