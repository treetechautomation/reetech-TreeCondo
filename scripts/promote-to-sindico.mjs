...
if (!condId || !uid) {
  console.log("USO: node scripts/promote-to-sindico.mjs <COND_ID> <UID>");
  process.exit(1);
}
...
console.log("✅ OK: promovido para SINDICO e vínculo sincronizado");
console.log({ condominioId: condId, uid, email, blocoId, unidadeId, role: "SINDICO" });
